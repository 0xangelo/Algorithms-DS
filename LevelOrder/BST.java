 ...
 * Número USP: 9293435
 *
 * Compilação: javac-algs4 BST.java
 * Execução:   Para esse exercício, não há a intenção de executar essa classe.
 *
 * Essa classe é uma modificação da original do capítulo 3.2 do livro, na qual
 * foram adicionados um método printLevel() (na linha 462) e um iterador BFS
 * (na linha 478), além de uma linha de código que permite a compilação com os
 * argumentos acima.
 *
 ******************************************************************************/
/******************************************************************************
...
public class BST<Key extends Comparable<Key>, Value> {
    ...
    public Iterable<Key> BFS(Node subTree) {
        Queue<Key> keys = new Queue<Key>();
        Queue<Node> queue = new Queue<Node>();
